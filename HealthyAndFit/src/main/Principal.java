...
public class Principal {
	...
	public static void main(String[] args) {
		Usuario p = new Usuario("Juan", "juan_perez", "Perez", "Carbon", new Date(), TipoSexo.HOMBRE, 1.75, 75, new ArrayList<TipoAlergias>(), "juan@gmail.com", new ArrayList<TipoEnfermedades>(), TipoPreferencia.NINGUNA, 12300, 3, "Ninguno", 300, new Date(), 13000, new Dieta().getNombre(), 3, "asd", new ImageIcon(System.getProperty("user.dir")+"\\resources\\images\\foto.png"));
